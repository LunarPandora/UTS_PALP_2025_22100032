...
import 'edit_pembelian_screen.dart';
...
class FetchPembelianScreen extends StatelessWidget {
  final box = Hive.box('stores');

  @override
  Widget build(BuildContext context) {
    final ref = FirebaseFirestore.instance.collection('stores').doc(box.get('code'));
    final pembelians = FirebaseFirestore.instance.collection(
      'incomingReceipts',
    ...
    return Scaffold(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () { 
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => PembelianEditPage(
                                    pembelianRef: document.reference,
                                    pembelianData: data,
                                  ))
                                );
                              },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PembelianFormPage())
          );
        },
